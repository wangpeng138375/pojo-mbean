...
/**
 * pojo-mbean demonstration sample application.<p>
 *
 * The application runs until manually stopped.<p>
 *
 * @ManagedAttribute methods will be called from multiple threads (application as well as MBean server)
 ...
 * <li>Use threadsafe types, and use them in a threadsafe manner (used in this example)</li>
 * </ul>
 *
 *  For more information about threadsafety, I hightly recommend the books "Effective Java", and "Concurrency in Practice".
 *
...
public class CountingApplication implements Callable<Object> {
    ...
    public CountingApplication() throws ManagementException, MalformedObjectNameException {
        ...
        // in a "real" application, the registration instance would probably be saved in a field for subsequent unregistration
    ...
    @ManagedOperation(Impact.ACTION_INFO) @Description("Increments the counter by the requested amount and shows the resulting value")
